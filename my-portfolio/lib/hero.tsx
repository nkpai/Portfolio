const Hero = () => {
    return (
      <section className="max-w-8xl min-h-screen mx-auto bg-base flex flex-col lg:flex-row items-center justify-center gap-16 lg:gap-20 px-8 py-8 lg:py-20 bg-gunmetal">
