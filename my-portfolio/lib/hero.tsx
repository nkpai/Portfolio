const Hero = () => {
    return (
      <section className="max-w-8xl min-h-screen mx-auto flex flex-col lg:flex-row items-center justify-center gap-16 lg:gap-20 px-8 py-2 lg:py-20 bg-main bg-no-repeat bg-cover bg-center sm:bg-center ">
        <div className="flex flex-col gap-10 lg:gap-14 items-center justify-center text-center lg:text-left lg:items-start pb-80">
         
          <h1 className="font-extrabold text-4xl lg:text-7xl tracking-tight md:mt-4 text-white lg:-mt-80 opacity-0  animation-delay-700 transition-opacity animate-fadeIn  ">
            Nathan Levine-Kpai.
          </h1>
          ...
          <a href="file:///C:/Users/icleq/OneDrive/Desktop/NathanLKResume2024.pdf" >
